...
| 10 => let val yytext=yymktext() in reservedWord(yytext, yypos, yypos) end
| 12 => (PLUS(yypos, yypos))
| 14 => (MINUS(yypos, yypos))
| 16 => (MULT(yypos, yypos))
| 18 => (DIV(yypos, yypos))
| 20 => (EQ(yypos, yypos))
| 23 => (NOTEQ(yypos, yypos))
| 25 => (LTH(yypos, yypos))
| 28 => (LTEQ(yypos, yypos))
| 30 => (COLON(yypos, yypos))
| 33 => (DBCOLON(yypos, yypos))
| 35 => (SEMICOL(yypos, yypos))
| 37 => (COMMA(yypos, yypos))
| 39 => (NOT(yypos, yypos))
| 4 => (lex())
| 42 => (AND(yypos, yypos))
| 44 => (LBRACE(yypos, yypos))
| 46 => (RBRACE(yypos, yypos))
| 48 => (LCURBR(yypos, yypos))
| 50 => (RCURBR(yypos, yypos))
| 52 => (LPAR(yypos, yypos))
| 54 => (RPAR(yypos, yypos))
| 57 => (ASSIGN(yypos, yypos))
| 60 => (ARROW(yypos, yypos))
| 62 => (PIPE(yypos, yypos))
| 64 => (error ("ignoring bad character"); lex())
